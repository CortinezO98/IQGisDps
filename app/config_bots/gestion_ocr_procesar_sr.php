<?php
    ...
    $consulta_string_resultado="SELECT `ocrr_id`, `ocrr_cod_familia`, `ocrr_codbeneficiario` FROM `gestion_ocr_resultado` WHERE `ocrr_cod_familia`=? AND (`ocrr_gestion_estado`='Segunda Revisión OCR' OR `ocrr_gestion_estado`='Documentos Cargados')";
