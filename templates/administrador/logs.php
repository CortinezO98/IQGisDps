<?php
  ...
  $consulta_contar_string="SELECT COUNT(`clog_id`) FROM `administrador_log` LEFT JOIN `administrador_usuario` AS TU ON `administrador_log`.`clog_registro_usuario`=TU.`usu_id` WHERE 1=1 ".$filtro_buscar."";
  ...
  $consulta_string_usuarios="SELECT `usu_id`, `usu_nombres_apellidos` FROM `administrador_usuario` ORDER BY `usu_nombres_apellidos`";
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
                ...
                <table class="table table-hover table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th class="px-1 py-2" style="min-width: 115px;">Fecha y Hora</th>
                      <th class="px-1 py-2">Módulo</th>
                      <th class="px-1 py-2" style="min-width: 95px;">Acción</th>
                      <th class="px-1 py-2">Detalle</th>
                      <th class="px-1 py-2">Documento Usuario</th>
                      <th class="px-1 py-2">Nombres y Apellidos</th>
                      <th class="px-1 py-2">Navegador</th>
                      <th class="px-1 py-2">Ip</th>
                      <th class="px-1 py-2">Fichero</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      <td class="p-1 text-center">
                        <?php echo log_icono($resultado_registros[$i][2]); ?>
                      </td>
        ...
        <!-- modal reportes -->
        <?php require_once('logs_reporte.php'); ?>
        <!-- modal -->
      </div>
      <!-- main-panel -->
    </div>
