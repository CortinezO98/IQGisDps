<?php
    ...
    if ($validacion=='programa') {
        ...
        if (count($resultado_registros)>0) {
            ...
            for ($i=0; $i < count($resultado_registros); $i++) { 
                $resultado_data.='<option value="'.$resultado_registros[$i][0].'" class="font-size-11">'.$resultado_registros[$i][2].'</option>';
            }
        } else {
            $resultado_control=0;
        }
    ...
    if ($validacion=='resultado') {
        ...
        if ($resultado=='Exitoso') {
            $resultado_data.='<option value="NO RESUELTA EN PRIMER CONTACTO" class="font-size-11">NO RESUELTA EN PRIMER CONTACTO</option>';
            $resultado_data.='<option value="SOLUCIÓN EN PRIMER CONTACTO" class="font-size-11">SOLUCIÓN EN PRIMER CONTACTO</option>';
            $resultado_control=1;
        } elseif ($resultado=='No exitoso') {
            $resultado_data.='<option value="ABANDONA SALA" class="font-size-11">ABANDONA SALA</option>';
            $resultado_data.='<option value="LLAMADA/SMS DE BROMA" class="font-size-11">LLAMADA/SMS DE BROMA</option>';
            $resultado_data.='<option value="LLAMADA/ CHAT EQUIVOCADA" class="font-size-11">LLAMADA/ CHAT EQUIVOCADA</option>';
            $resultado_data.='<option value="LLAMADA/SMS O INTERACCIÓN DE PRUEBA " class="font-size-11">LLAMADA/SMS O INTERACCIÓN DE PRUEBA </option>';
            $resultado_data.='<option value="LLAMADA NO SE ESCUCHA" class="font-size-11">LLAMADA NO SE ESCUCHA</option>';
            $resultado_data.='<option value="SE CORTÓ LLAMADA" class="font-size-11">SE CORTÓ LLAMADA</option>';
            $resultado_control=1;
        }
    }
    ...
    if ($validacion=='descripcion_resultado') {
        ...
        if ($descripcion_resultado=='NO RESUELTA EN PRIMER CONTACTO') {
            $resultado_data.='<option value="SE CORTÓ LLAMADA" class="font-size-11">SE CORTÓ LLAMADA</option>';
            $resultado_data.='<option value="NO SUPERA FILTRO" class="font-size-11">NO SUPERA FILTRO</option>';
            $resultado_data.='<option value="ABANDONA SALA DE CHAT" class="font-size-11">ABANDONA SALA DE CHAT</option>';
            $resultado_data.='<option value="SIN SISTEMA" class="font-size-11">SIN SISTEMA</option>';
            $resultado_control=1;
        } else {
            $resultado_control=0;
        }
