<?php
  ...
  /*VARIABLES*/
  $title = "Calidad";
  $subtitle = "Monitoreos | Refutado Nivel 2 - Aceptar";
  ...
  if(isset($_POST["guardar_registro"])){
      ...
      $tipo_cambio="Refutar-Aceptado-Nivel 2";
      ...
      if($_SESSION[APP_SESSION.'_registro_creado_cambio_estado']!=1){
          ...
          if ($control_estado_enc==1 AND $control_estado_ecuf==1 AND $control_estado_ecn==1) {
              ...
              $gcm_estado="Refutado-Aceptado-Nivel 2";
          }
          ...
          if ($sentencia_insert->execute()) {
              // Prepara la sentencia
              $consulta_actualizar = $enlace_db->prepare("UPDATE `gestion_calidad_monitoreo` SET `gcm_observaciones_monitoreo`=?, `gcm_nota_enc`=?, `gcm_nota_ecn`=?, `gcm_nota_ecuf`=?, `gcm_nota_enc_estado`=?, `gcm_nota_ecn_estado`=?, `gcm_nota_ecuf_estado`=?, `gcm_estado`=?, `gcm_fecha_sreac`='".date('Y-m-d H:i:s')."' WHERE `gcm_id`=?");
              ...
              if (comprobarSentencia($enlace_db->info)) {
                  ...
                  if (count($items_matriz)==$control_insert) {
                      ...
                      $asunto='Refutado Nivel 2-Aceptado | '.$id_registro;
                      $referencia='Monitoreo Refutado Nivel 2-Aceptado';
                ...
                <div class="col-12 grid-margin stretch-card">
                  <div class="card card-rounded">
                    <div class="card-body">
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                            <label for="observaciones_refute">Observaciones Refutado-Aceptar-Nivel 2</label>
