<?php
  ...
  /*VARIABLES*/
  $title = "Calidad";
  $subtitle = "Monitoreos | Refutado Nivel 2-Rechazar";
  ...
  if(isset($_POST["guardar_registro"])){
      ...
      $tipo_cambio="Refutar-Rechazado-Nivel 2";
      $estado="Refutado-Rechazado-Nivel 2";
      ...
      if($_SESSION[APP_SESSION.'_registro_creado_cambio_estado']!=1){
          ...
          if ($sentencia_insert->execute()) {
              // Prepara la sentencia
              $consulta_actualizar = $enlace_db->prepare("UPDATE `gestion_calidad_monitoreo` SET `gcm_estado`=?, `gcm_fecha_sreac`='".date('Y-m-d H:i:s')."' WHERE `gcm_id`=?");
              ...
              if (comprobarSentencia($enlace_db->info)) {
                  ...
                  $asunto='Refutado-Rechazado Nivel 2 | '.$id_registro;
                  $referencia='Monitoreo Refutado Nivel 2-Rechazado';
                  ...
                  $nc_address=$resultado_registros_monitoreo[0][60].";";
                  $nc_cc=$resultado_registros_monitoreo[0][61].";".$resultado_registros_monitoreo[0][59].";";
              ...
              <div class="row flex-grow">
                <div class="col-12 grid-margin stretch-card">
                  <div class="card card-rounded">
                    <div class="card-body">
                      <?php //if(date('Y-m-d H:i:s')<$resultado_registros_monitoreo[0][54]): ?>
                      <?php if(1): ?>
                          <div class="col-md-12">
