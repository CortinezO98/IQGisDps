<?php
  ...
  /*VARIABLES*/
  $title = "Calidad";
  $subtitle = "Monitoreos | Refutado-Rechazar";
  ...
  if(isset($_POST["guardar_registro"])){
      ...
      if($_SESSION[APP_SESSION.'_registro_creado_cambio_estado']!=1){
          ...
          if ($sentencia_insert->execute()) {
              ...
              // Prepara la sentencia
              $consulta_actualizar = $enlace_db->prepare("UPDATE `gestion_calidad_monitoreo` SET `gcm_estado`=?, `gcm_fecha_calidad_reac`='".date('Y-m-d H:i:s')."', `gcm_fecha_snivel_reac_limite`=? WHERE `gcm_id`=?");
              ...
              if (comprobarSentencia($enlace_db->info)) {
                  ...
                  $asunto='Refutado-Rechazado | '.$id_registro;
                  $referencia='Monitoreo Refutado-Rechazado';
              ...
              <div class="row flex-grow">
                <div class="col-12 grid-margin stretch-card">
                  <div class="card card-rounded">
                    <div class="card-body">
                      <?php //if(date('Y-m-d H:i:s')<$resultado_registros_monitoreo[0][50]): ?>
                      <?php if(1): ?>
                          <div class="col-md-12">
