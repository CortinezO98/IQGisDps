            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">4. Formato de Gestión de Correos</p>
                </div>
                <div class="col-md-12">
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Comparativo por Estado y Proyector</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p4_g4"></div>
                  ...
                  <table class="table table-hover table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <?php if(isset($array_datos_gestion['p4']['estado_lista'])): ?>
                          <?php for ($i=0; $i < count($array_datos_gestion['p4']['estado_lista']); $i++): ?>
                            <th class="px-1 py-2"><?php echo $array_datos_gestion['p4']['estado_nombre'][$array_datos_gestion['p4']['estado_lista'][$i]]; ?></th>
                          <?php endfor; ?>
                        <?php endif; ?>
                    ...
                    <tbody>
                      <?php if(isset($array_datos_gestion['p4']['proyector_lista'])): ?>
                        <?php for ($i=0; $i < count($array_datos_gestion['p4']['proyector_lista']); $i++): ?>
                          <tr>
                            <td class="p-1 text-center">
                                <?php echo $array_datos_gestion['p4']['proyector_nombre'][$array_datos_gestion['p4']['proyector_lista'][$i]]; ?>
                            </td>
                            <?php for ($j=0; $j < count($array_datos_gestion['p4']['estado_lista']); $j++): ?>
                              <td class="p-1 font-size-11 text-center">
                                <?php if(isset($array_datos_gestion['p4']['proyector_estado'][$array_datos_gestion['p4']['proyector_lista'][$i]][$array_datos_gestion['p4']['estado_lista'][$j]])): ?>
                                  <?php echo $array_datos_gestion['p4']['proyector_estado'][$array_datos_gestion['p4']['proyector_lista'][$i]][$array_datos_gestion['p4']['estado_lista'][$j]]; ?>
                                <?php else: ?>
                            ...
                            <?php endfor; ?>
                            <td class="p-1 text-center">
                                <?php echo $array_datos_gestion['p4']['proyector_estado_total'][$array_datos_gestion['p4']['proyector_lista'][$i]]; ?>
                            </td>
                          </tr>
                        <?php endfor; ?>
                      <?php endif; ?>
...
<script type="text/javascript">
  ...
  Highcharts.chart('p4_g4', {
      chart: {
          type: 'bar',
          height: '<?php echo (isset($array_datos_gestion['p4']['agente_lista'])) ? (count($array_datos_gestion['p4']['agente_lista'])>2) ? count($array_datos_gestion['p4']['agente_lista'])*55 : '150' : '150'; ?> px'
      },
      title: {
          text: null
      },
      ...
      xAxis: {
          categories: [
            <?php if(isset($array_datos_gestion['p4']['agente_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p4']['agente_lista']); $i++): ?>
                '<?php echo $array_datos_gestion['p4']['agente_nombre'][$array_datos_gestion['p4']['agente_lista'][$i]]; ?>',
              <?php endfor; ?>
            <?php endif; ?>
          ],
          crosshair: true
      ...
      series: [
        <?php if(isset($array_datos_gestion['p4']['agente_lista'])): ?>
          <?php for ($i=0; $i < count($array_datos_gestion['p4']['estado_lista']); $i++): ?>
          {
              name: '<?php echo $array_datos_gestion['p4']['estado_nombre'][$array_datos_gestion['p4']['estado_lista'][$i]]; ?>',
              data: [
                <?php for ($j=0; $j < count($array_datos_gestion['p4']['agente_lista']); $j++): ?>
                  <?php if(isset($array_datos_gestion['p4']['agente'][$array_datos_gestion['p4']['agente_lista'][$j]][$array_datos_gestion['p4']['estado_lista'][$i]])): ?>
                    <?php echo $array_datos_gestion['p4']['agente'][$array_datos_gestion['p4']['agente_lista'][$j]][$array_datos_gestion['p4']['estado_lista'][$i]]; ?>,
                  <?php else: ?>
                    0,
                  <?php endif; ?>
                <?php endfor; ?>
