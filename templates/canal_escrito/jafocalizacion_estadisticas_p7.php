            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">7. Formato Gestión de Aprobación JeA</p>
                </div>
                <div class="col-md-12">
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Comparativo por Estado y Abogado aprobador</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p7_g4"></div>
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Comparativa por Estado y Agente</h6>
                </div>
              </div>
              <div class="col-md-12">
                  ...
                  <table class="table table-hover table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <?php if(isset($array_datos_gestion['p7']['estado_lista'])): ?>
                          <?php for ($i=0; $i < count($array_datos_gestion['p7']['estado_lista']); $i++): ?>
                            <th class="px-1 py-2"><?php echo $array_datos_gestion['p7']['estado_nombre'][$array_datos_gestion['p7']['estado_lista'][$i]]; ?></th>
                          <?php endfor; ?>
                        <?php endif; ?>
                    ...
                    <tbody>
                      <?php if(isset($array_datos_gestion['p7']['agente_lista'])): ?>
                        <?php for ($i=0; $i < count($array_datos_gestion['p7']['agente_lista']); $i++): ?>
                          <tr>
                            <td class="p-1 text-center">
                                <?php echo $array_datos_gestion['p7']['agente_nombre'][$array_datos_gestion['p7']['agente_lista'][$i]]; ?>
                            </td>
                            <?php for ($j=0; $j < count($array_datos_gestion['p7']['estado_lista']); $j++): ?>
                              <td class="p-1 font-size-11 text-center">
                                <?php if(isset($array_datos_gestion['p7']['agente_estado'][$array_datos_gestion['p7']['agente_lista'][$i]][$array_datos_gestion['p7']['estado_lista'][$j]])): ?>
                                  <?php echo $array_datos_gestion['p7']['agente_estado'][$array_datos_gestion['p7']['agente_lista'][$i]][$array_datos_gestion['p7']['estado_lista'][$j]]; ?>
                                <?php else: ?>
                            ...
                            <?php endfor; ?>
                            <td class="p-1 text-center">
                                <?php echo $array_datos_gestion['p7']['agente_estado_total'][$array_datos_gestion['p7']['agente_lista'][$i]]; ?>
                            </td>
                          </tr>
                        <?php endfor; ?>
                      <?php endif; ?>
...
<script type="text/javascript">
  ...
  Highcharts.chart('p7_g4', {
      chart: {
          type: 'bar',
          height: '<?php echo (isset($array_datos_gestion['p7']['proyector_lista'])) ? (count($array_datos_gestion['p7']['proyector_lista'])>2) ? count($array_datos_gestion['p7']['proyector_lista'])*55 : '150' : '150'; ?> px'
      },
      title: {
          text: null
      },
      ...
      series: [
        <?php if(isset($array_datos_gestion['p7']['proyector_lista'])): ?>
          <?php for ($i=0; $i < count($array_datos_gestion['p7']['estado_lista']); $i++): ?>
          {
              name: '<?php echo $array_datos_gestion['p7']['estado_nombre'][$array_datos_gestion['p7']['estado_lista'][$i]]; ?>',
              data: [
                <?php for ($j=0; $j < count($array_datos_gestion['p7']['proyector_lista']); $j++): ?>
                  <?php if(isset($array_datos_gestion['p7']['proyector'][$array_datos_gestion['p7']['proyector_lista'][$j]][$array_datos_gestion['p7']['estado_lista'][$i]])): ?>
                    <?php echo $array_datos_gestion['p7']['proyector'][$array_datos_gestion['p7']['proyector_lista'][$j]][$array_datos_gestion['p7']['estado_lista'][$i]]; ?>,
                  <?php else: ?>
                    0,
                  <?php endif; ?>
                <?php endfor; ?>
