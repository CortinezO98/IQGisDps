            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">6. Aprobación Firma</p>
                </div>
                <div class="col-md-12">
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Comparativa por afectación a</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p6_g4"></div>
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Comparativa por tipo de carta</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p6_g5"></div>
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Comparativa por estado y tipificador</h6>
                </div>
              </div>
              <div class="col-md-12">
                  ...
                  <table class="table table-hover table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <?php if(isset($array_datos_gestion['p6']['estado_lista'])): ?>
                          <?php for ($i=0; $i < count($array_datos_gestion['p6']['estado_lista']); $i++): ?>
                            <th class="px-1 py-2"><?php echo $array_datos_gestion['p6']['estado_nombre'][$array_datos_gestion['p6']['estado_lista'][$i]]; ?></th>
                          <?php endfor; ?>
                        <?php endif; ?>
                    ...
                    <tbody>
                      <?php if(isset($array_datos_gestion['p6']['proyector_lista'])): ?>
                        <?php for ($i=0; $i < count($array_datos_gestion['p6']['proyector_lista']); $i++): ?>
                          <tr>
                            <td class="p-1 text-center">
                                <?php echo $array_datos_gestion['p6']['proyector_nombre'][$array_datos_gestion['p6']['proyector_lista'][$i]]; ?>
                            </td>
                            <?php for ($j=0; $j < count($array_datos_gestion['p6']['estado_lista']); $j++): ?>
                              <td class="p-1 font-size-11 text-center">
                                <?php if(isset($array_datos_gestion['p6']['proyector_estado'][$array_datos_gestion['p6']['proyector_lista'][$i]][$array_datos_gestion['p6']['estado_lista'][$j]])): ?>
                                  <?php echo $array_datos_gestion['p6']['proyector_estado'][$array_datos_gestion['p6']['proyector_lista'][$i]][$array_datos_gestion['p6']['estado_lista'][$j]]; ?>
                                <?php else: ?>
                            ...
                            <?php endfor; ?>
                            <td class="p-1 text-center">
                                <?php echo $array_datos_gestion['p6']['proyector_estado_total'][$array_datos_gestion['p6']['proyector_lista'][$i]]; ?>
                            </td>
                          </tr>
                        <?php endfor; ?>
                      <?php endif; ?>
...
<script type="text/javascript">
  ...
  Highcharts.chart('p6_g4', {
      chart: {
          type: 'bar',
          height: '<?php echo (isset($array_datos_gestion['p6']['afectaciona_lista'])) ? (count($array_datos_gestion['p6']['afectaciona_lista'])>2) ? count($array_datos_gestion['p6']['afectaciona_lista'])*40 : '150' : '150'; ?> px'
      },
      title: {
          text: null
      },
      ...
      xAxis: {
          categories: [
            <?php if(isset($array_datos_gestion['p6']['afectaciona_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p6']['afectaciona_lista']); $i++): ?>
                '<?php echo $array_datos_gestion['p6']['afectaciona_nombre'][$array_datos_gestion['p6']['afectaciona_lista'][$i]]; ?>',
              <?php endfor; ?>
            <?php endif; ?>
          ],
          crosshair: true
      ...
      series: [{
          ...
          data: [
            <?php if(isset($array_datos_gestion['p6']['afectaciona_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p6']['afectaciona_lista']); $i++): ?>
                <?php if(isset($array_datos_gestion['p6']['afectaciona'][$array_datos_gestion['p6']['afectaciona_lista'][$i]])): ?>
                  <?php echo $array_datos_gestion['p6']['afectaciona'][$array_datos_gestion['p6']['afectaciona_lista'][$i]]; ?>,
                <?php else: ?>
                  0,
                <?php endif; ?>
              <?php endfor; ?>
  ...
  Highcharts.chart('p6_g5', {
      ...
      xAxis: {
          categories: [
            <?php if(isset($array_datos_gestion['p6']['carta_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p6']['carta_lista']); $i++): ?>
                '<?php echo $array_datos_gestion['p6']['carta_nombre'][$array_datos_gestion['p6']['carta_lista'][$i]]; ?>',
              <?php endfor; ?>
            <?php endif; ?>
          ],
          crosshair: true
      ...
      series: [{
          ...
          data: [
            <?php if(isset($array_datos_gestion['p6']['carta_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p6']['carta_lista']); $i++): ?>
                <?php if(isset($array_datos_gestion['p6']['carta'][$array_datos_gestion['p6']['carta_lista'][$i]])): ?>
                  <?php echo $array_datos_gestion['p6']['carta'][$array_datos_gestion['p6']['carta_lista'][$i]]; ?>,
                <?php else: ?>
                  0,
                <?php endif; ?>
              <?php endfor; ?>
