            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">7. Firma Traslados</p>
                </div>
                <div class="col-md-12">
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Comparativa por tipo de error forma</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p7_g4"></div>
...
<script type="text/javascript">
  ...
  Highcharts.chart('p7_g4', {
      ...
      series: [{
          ...
          colorByPoint: true,
          data: [
            <?php if(isset($array_datos_gestion['p7']['forma_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p7']['forma_lista']); $i++): ?>
              {
                  name: '<?php echo $array_datos_gestion['p7']['forma_nombre'][$array_datos_gestion['p7']['forma_lista'][$i]]; ?>',
                  y: <?php echo $array_datos_gestion['p7']['forma'][$array_datos_gestion['p7']['forma_lista'][$i]]; ?>
              },
              <?php endfor; ?>
            <?php endif; ?>
          ]
