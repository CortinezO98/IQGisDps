            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">8. Proyectores</p>
                </div>
                <div class="col-md-12">
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Comparativa por Novedad de radicado y Agente responsable</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p8_g6"></div>
...
<script type="text/javascript">
  ...
  Highcharts.chart('p8_g4', {
      ...
      series: [{
          ...
          colorByPoint: true,
          data: [
            <?php if(isset($array_datos_gestion['p8']['direccionamiento_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p8']['direccionamiento_lista']); $i++): ?>
              {
                  name: '<?php echo $array_datos_gestion['p8']['direccionamiento_nombre'][$array_datos_gestion['p8']['direccionamiento_lista'][$i]]; ?>',
                  y: <?php echo $array_datos_gestion['p8']['direccionamiento'][$array_datos_gestion['p8']['direccionamiento_lista'][$i]]; ?>
              },
              <?php endfor; ?>
            <?php endif; ?>
          ]
  ...
  Highcharts.chart('p8_g6', {
      chart: {
          type: 'bar',
          height: '<?php echo (isset($array_datos_gestion['p8']['agente_lista'])) ? (count($array_datos_gestion['p8']['agente_lista'])>2) ? count($array_datos_gestion['p8']['agente_lista'])*60 : '150' : '150'; ?> px'
      },
      title: {
          text: null
      },
      ...
      xAxis: {
          categories: [
            <?php if(isset($array_datos_gestion['p8']['agente_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p8']['agente_lista']); $i++): ?>
                '<?php echo $array_datos_gestion['p8']['agente_nombre'][$array_datos_gestion['p8']['agente_lista'][$i]]; ?>',
              <?php endfor; ?>
            <?php endif; ?>
          ],
          crosshair: true
      ...
      series: [
        <?php if(isset($array_datos_gestion['p8']['agente_lista'])): ?>
          <?php for ($i=0; $i < count($array_datos_gestion['p8']['novedad_lista']); $i++): ?>
          {
              name: '<?php echo $array_datos_gestion['p8']['novedad_nombre'][$array_datos_gestion['p8']['novedad_lista'][$i]]; ?>',
              data: [
                <?php for ($j=0; $j < count($array_datos_gestion['p8']['agente_lista']); $j++): ?>
                  <?php if(isset($array_datos_gestion['p8']['agente_novedad'][$array_datos_gestion['p8']['agente_lista'][$j]][$array_datos_gestion['p8']['novedad_lista'][$i]])): ?>
                    <?php echo $array_datos_gestion['p8']['agente_novedad'][$array_datos_gestion['p8']['agente_lista'][$j]][$array_datos_gestion['p8']['novedad_lista'][$i]]; ?>,
                  <?php else: ?>
                    0,
                  <?php endif; ?>
                <?php endfor; ?>
