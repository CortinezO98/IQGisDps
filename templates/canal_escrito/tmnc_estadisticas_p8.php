            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">8. Aprobación Novedades CM</p>
                </div>
                <div class="col-md-12">
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Tipos de novedad</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p8_g4"></div>
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Tipos de novedad | Datos Básicos</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p8_g5"></div>
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Tipos de novedad | Reactivación</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p8_g6"></div>
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Tipos de novedad | Retiro</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p8_g7"></div>
        ...
        <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card my-1">
          <div class="card card-rounded">
            <div class="card-body">
              <div class="d-sm-flex justify-content-between align-items-start">
                <div>
                  <h6 class="fw-bold card-title-dash">Tipos de novedad | Suspensión</h6>
                </div>
              </div>
              <div class="col-md-12">
                <div id="p8_g8"></div>
...
<script type="text/javascript">
  ...
  Highcharts.chart('p8_g4', {
      ...
      series: [{
          ...
          colorByPoint: true,
          data: [
            <?php if(isset($array_datos_gestion['p8']['tipo_novedad_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p8']['tipo_novedad_lista']); $i++): ?>
              {
                  name: '<?php echo $array_datos_gestion['p8']['tipo_novedad_nombre'][$array_datos_gestion['p8']['tipo_novedad_lista'][$i]]; ?>',
                  y: <?php echo $array_datos_gestion['p8']['tipo_novedad'][$array_datos_gestion['p8']['tipo_novedad_lista'][$i]]; ?>
              },
              <?php endfor; ?>
            <?php endif; ?>
          ]
  ...
  Highcharts.chart('p8_g5', {
      ...
      series: [{
          ...
          colorByPoint: true,
          data: [
            <?php if(isset($array_datos_gestion['p8']['datos_basicos_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p8']['datos_basicos_lista']); $i++): ?>
              {
                  name: '<?php echo $array_datos_gestion['p8']['datos_basicos_nombre'][$array_datos_gestion['p8']['datos_basicos_lista'][$i]]; ?>',
                  y: <?php echo $array_datos_gestion['p8']['datos_basicos'][$array_datos_gestion['p8']['datos_basicos_lista'][$i]]; ?>
              },
              <?php endfor; ?>
            <?php endif; ?>
          ]
  ...
  Highcharts.chart('p8_g6', {
      ...
      series: [{
          ...
          colorByPoint: true,
          data: [
            <?php if(isset($array_datos_gestion['p8']['reactivacion_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p8']['reactivacion_lista']); $i++): ?>
              {
                  name: '<?php echo $array_datos_gestion['p8']['reactivacion_nombre'][$array_datos_gestion['p8']['reactivacion_lista'][$i]]; ?>',
                  y: <?php echo $array_datos_gestion['p8']['reactivacion'][$array_datos_gestion['p8']['reactivacion_lista'][$i]]; ?>
              },
              <?php endfor; ?>
            <?php endif; ?>
          ]
  ...
  Highcharts.chart('p8_g7', {
      ...
      series: [{
          ...
          colorByPoint: true,
          data: [
            <?php if(isset($array_datos_gestion['p8']['retiro_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p8']['retiro_lista']); $i++): ?>
              {
                  name: '<?php echo $array_datos_gestion['p8']['retiro_nombre'][$array_datos_gestion['p8']['retiro_lista'][$i]]; ?>',
                  y: <?php echo $array_datos_gestion['p8']['retiro'][$array_datos_gestion['p8']['retiro_lista'][$i]]; ?>
              },
              <?php endfor; ?>
            <?php endif; ?>
          ]
  ...
  Highcharts.chart('p8_g8', {
      ...
      series: [{
          ...
          colorByPoint: true,
          data: [
            <?php if(isset($array_datos_gestion['p8']['suspension_lista'])): ?>
              <?php for ($i=0; $i < count($array_datos_gestion['p8']['suspension_lista']); $i++): ?>
              {
                  name: '<?php echo $array_datos_gestion['p8']['suspension_nombre'][$array_datos_gestion['p8']['suspension_lista'][$i]]; ?>',
                  y: <?php echo $array_datos_gestion['p8']['suspension'][$array_datos_gestion['p8']['suspension_lista'][$i]]; ?>
              },
              <?php endfor; ?>
            <?php endif; ?>
          ]
