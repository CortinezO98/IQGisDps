<div class="tab-pane fade mt-0" id="ja_p1" role="tabpanel" aria-labelledby="ja_p1"> 
  <div class="row">
            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">JeA y Focalización | 1. Proyección de Peticiones Vivienda</p>
                  <?php $id_formulario='jafocalizacion_proyeccion_peticiones'; ?>
                </div>
...
<script type="text/javascript">
  ...
  // var chartSpeed = Highcharts.chart('ja_p1_g1', Highcharts.merge(gaugeOptions, {
  //     yAxis: {
  //         min: 0,
  //         max: 100,
  //         title: {
