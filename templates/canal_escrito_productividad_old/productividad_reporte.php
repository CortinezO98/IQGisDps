...
<div class="modal fade" id="modal-reporte" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form name="reporte" action="productividad_reporte_excel.php" method="POST">
        ...
        <div class="row">
          ...
          <!-- <div class="col-md-12">
              <div class="form-group my-1">
                  <label for="agente" class="my-0">Agente</label>
                  <select class="form-control form-control-sm form-select" name="agente" id="agente" required>
                      <option value="Todos">Todos</option>
                      <?php for ($i=0; $i < count($resultado_registros_analistas); $i++): ?>
                        <option value="<?php echo $resultado_registros_analistas[$i][0]; ?>"><?php echo $resultado_registros_analistas[$i][1]; ?></option>
                      <?php endfor; ?>
                  </select>
              </div>
          </div> -->
