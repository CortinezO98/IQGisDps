...
// ini_set('display_errors', '1');
  ...
  $consulta_registros_meta_hist->bind_param("s", $_SESSION[APP_SESSION.'_session_ce_productividad']['fecha_inicio']);
  ...
  for ($i=0; $i < count($resultado_registros_meta); $i++) {
    if ($_SESSION[APP_SESSION.'_session_ce_productividad']['fecha_inicio']==date('Y-m-d') OR !isset($array_metas_hist[$resultado_registros_meta[$i][0]]['meta'])) {
  ...
  if ($_SESSION[APP_SESSION.'_session_ce_productividad']['fecha_inicio']==date('Y-m-d')) {
