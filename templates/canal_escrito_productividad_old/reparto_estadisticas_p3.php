            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">Reparto | 3. Firma FA</p>
                  <?php $id_formulario='reparto_firma_fa'; ?>
                </div>
...
<script type="text/javascript">
  ...
  // var chartSpeed = Highcharts.chart('p3_g1', Highcharts.merge(gaugeOptions, {
  //     yAxis: {
  //         min: 0,
  //         max: 100,
  //         title: {
