<div class="tab-pane fade mt-0" id="tm_p2" role="tabpanel" aria-labelledby="tm_p2"> 
  <div class="row">
            ...
            <div class="card-body py-2">
              <div class="row">
                <div class="col-md-12 mb-2">
                  <p class="alert background-principal color-blanco py-1 px-2 my-0">TMNC | 2. Aprobación Respuesta</p>
                <?php $id_formulario='tmnc_saprobacion_respuestas'; ?>
                </div>
...
<script type="text/javascript">
  ...
  // var chartSpeed = Highcharts.chart('tm_p2_g1', Highcharts.merge(gaugeOptions, {
  //     yAxis: {
  //         min: 0,
  //         max: 100,
  //         title: {
