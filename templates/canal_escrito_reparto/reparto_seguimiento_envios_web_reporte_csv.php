<?php
    ...
    if(isset($_POST["reporte"])){
        ...
        $titulo_reporte="Canal Escrito - Seguimiento Envíos Web - ".date('Y-m-d H_i_s').".csv";
    ...
    fputcsv($file, array('Reporte: Canal Escrito - Seguimiento Envíos Web'), $delimitador, $encapsulador);
    fputcsv($file, array('Fecha filtro: '.$fecha_inicio.' A '.$fecha_fin), $delimitador, $encapsulador);
    
    $titulos=array('Radicado Entrada', 'Radicado Salida', 'Tipo Envío', 'Estado', 'Observaciones', 'Doc Usuario Registro', 'Registrado por', 'Fecha Registro');
