<?php
    ...
    if(isset($_POST["reporte"])){
        ...
        $titulo_reporte="Canal Escrito - TMNC - 6. Pendientes Clasificación - ".date('Y_m_d H_i_s').".csv";
    ...
    fputcsv($file, array('Reporte: Canal Escrito TMNC - 6. Pendientes Clasificación'), $delimitador, $encapsulador);
    fputcsv($file, array('Fecha filtro: '.$fecha_inicio.' A '.$fecha_fin), $delimitador, $encapsulador);
    
    $titulos=array('Pendientes por clasificar', 'Observaciones', 'Doc Usuario Registro', 'Registrado por', 'Fecha Registro');

    fputcsv($file, $titulos, $delimitador, $encapsulador);

    for ($i=0; $i < count($resultado_registros); $i++) {
        $linea=array($resultado_registros[$i][2], $resultado_registros[$i][3], $resultado_registros[$i][5], $resultado_registros[$i][7], $resultado_registros[$i][6]);
