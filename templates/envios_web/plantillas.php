<?php
  ...
  if ($filtro_permanente!="null" AND $filtro_permanente!="") {
      $filtro_buscar="AND (`gewcp_nombre` LIKE ?)";
  ...
  $consulta_contar_string="SELECT COUNT(`gewcp_id`) FROM `gestion_enviosweb_casos_plantillas` LEFT JOIN `administrador_usuario` AS TUA ON `gestion_enviosweb_casos_plantillas`.`gewcp_actualiza_usuario`=TUA.`usu_id` WHERE 1=1 ".$filtro_buscar."";
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-9 mb-1 text-end">
              <a href="plantillas_crear?pagina=<?php echo $pagina; ?>&id=<?php echo $filtro_permanente; ?>" class="btn py-2 px-2 btn-primary btn-corp btn-icon-text font-size-12" title="Crear Plantilla">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="p-1 text-center">
                          <a href="plantillas_editar?pagina=<?php echo $pagina; ?>&id=<?php echo $filtro_permanente; ?>&reg=<?php echo base64_encode($resultado_registros[$i][0]); ?>" class="btn btn-warning btn-icon px-1 py-1 mb-1" title="Editar"><i class="fas fa-pen font-size-11"></i></a>
                      </td>
