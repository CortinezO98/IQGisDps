 ...
 * Procesador POST del formulario de encuesta de satisfacción.
 */
...
// ── Recoger y validar calificaciones ─────────────────────────────────────
...
foreach ($campos_cal as $c) {
    ...
    if ($v < 1 || $v > 5) {
        $errores[] = 'La calificación "' . $c . '" es requerida y debe estar entre 1 y 5.';
    } else {
        $cal[$c] = $v;
    }
}
