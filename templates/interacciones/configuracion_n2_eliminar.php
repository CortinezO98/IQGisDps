<?php
  ...
  /*VARIABLES*/
  $title = "Interacciones";
  $subtitle = "Configuración | Tipificación 2 | Eliminar";
  ...
  if(isset($_POST["eliminar_registro"])){
      if($_SESSION[APP_SESSION.'_registro_eliminado_interacciones_configuracion']!=1){
          ...
          $sentencia_delete = $enlace_db->prepare("DELETE FROM `gestion_interacciones_catnivel2` WHERE `gic2_id`=?");
  ...
  $consulta_string_validar="SELECT COUNT(`gic3_id`) FROM `gestion_interacciones_catnivel3` WHERE `gic3_padre`=?";
  ...
  $consulta_string_uso="SELECT COUNT(`gi_programa`) FROM `gestion_interacciones_historico` WHERE `gi_programa`=?";
                      ...
                      <?php else: ?>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm form-select font-size-11" name="gic2_estado" id="gic2_estado" required disabled>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm form-select font-size-11" name="gic2_padre" id="gic2_padre" required disabled>
                                  <option value="">Seleccione</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-sm font-size-11" name="gic2_item" id="gic2_item" maxlength="100" value="<?php echo $resultado_registros[0][2]; ?>" required disabled>
                            </div>
                        </div>
