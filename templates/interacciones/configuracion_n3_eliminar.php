<?php
  ...
  /*VARIABLES*/
  $title = "Interacciones";
  $subtitle = "Configuración | Tipificación 3 | Eliminar";
  ...
  if(isset($_POST["eliminar_registro"])){
      if($_SESSION[APP_SESSION.'_registro_eliminado_interacciones_configuracion']!=1){
          ...
          $sentencia_delete = $enlace_db->prepare("DELETE FROM `gestion_interacciones_catnivel3` WHERE `gic3_id`=?");
  ...
  $consulta_string_uso="SELECT COUNT(`gi_tipificacion`) FROM `gestion_interacciones_historico` WHERE `gi_tipificacion`=?";
                ...
                <div class="col-12 grid-margin stretch-card">
                  <div class="card card-rounded">
                    <div class="card-body">
                      ...
                      <?php else: ?>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm form-select font-size-11" name="gic3_estado" id="gic3_estado" required disabled>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-sm font-size-11" name="gic3_item" id="gic3_item" maxlength="100" value="<?php echo $resultado_registros[0][2]; ?>" required disabled>
                            </div>
                        </div>
                        <?php if($resultado_registros_uso[0][0]>0): ?>
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                              <?php if($_SESSION[APP_SESSION.'_registro_eliminado_interacciones_configuracion']==1 OR $resultado_registros_uso[0][0]>0): ?>
