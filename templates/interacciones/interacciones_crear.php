...
// ini_set('display_errors', '1');
  ...
  if(isset($_POST["guardar_registro"])){
      ...
      if($dup_id_caso=='' AND ($canal_atencion=='SMS' OR $canal_atencion=='WhatsApp') AND $id_encuesta_fecha!='') {
        if ($dup_id_encuesta!="") {
          ...
          if ($municipio!="" OR $tipo_documento=='NO IDENTIFICADO') {
            if ($sentencia_insert_detalle->execute()) {
                ...
                if ($canal_atencion=="Redes Sociales" OR $canal_atencion=="Chat Web" OR $canal_atencion=="WhatsApp" OR $canal_atencion=="Video llamada" OR $canal_atencion=="SMS") {
                  // Prepara la sentencia
                  $sentencia_insert_usuario = $enlace_db->prepare("INSERT INTO `gestion_interacciones_usuarios`(`giu_identificacion`, `giu_tipo_documento`, `giu_primer_nombre`, `giu_segundo_nombre`, `giu_primer_apellido`, `giu_segundo_apellido`, `giu_fecha_nacimiento`, `giu_municipio`, `giu_telefono`, `giu_celular`, `giu_email`, `giu_direccion`, `giu_informacion_poblacional`, `giu_atencion_preferencial`, `giu_genero`, `giu_escolaridad`, `giu_fecha_actualiza`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `giu_tipo_documento`=?, `giu_primer_nombre`=?, `giu_segundo_nombre`=?, `giu_primer_apellido`=?, `giu_segundo_apellido`=?, `giu_fecha_nacimiento`=?, `giu_municipio`=?, `giu_telefono`=?, `giu_celular`=?, `giu_email`=?, `giu_direccion`=?, `giu_fecha_actualiza`=?");
                  // Agrega variables a sentencia preparada
                  $sentencia_insert_usuario->bind_param('sssssssssssssssssssssssssssss', $identificacion, $tipo_documento, $primer_nombre, $segundo_nombre, $primer_apellido, $segundo_apellido, $fecha_nacimiento, $municipio, $telefono, $celular, $email, $direccion, $informacion_poblacional_insert, $atencion_preferencial_insert, $genero, $escolaridad, date('Y-m-d H:i:s'), $tipo_documento, $primer_nombre, $segundo_nombre, $primer_apellido, $segundo_apellido, $fecha_nacimiento, $municipio, $telefono, $celular, $email, $direccion, date('Y-m-d H:i:s'));
                  $sentencia_insert_usuario->execute();
                } else {
                  // Prepara la sentencia
                  $sentencia_insert_usuario = $enlace_db->prepare("INSERT INTO `gestion_interacciones_usuarios`(`giu_identificacion`, `giu_tipo_documento`, `giu_primer_nombre`, `giu_segundo_nombre`, `giu_primer_apellido`, `giu_segundo_apellido`, `giu_fecha_nacimiento`, `giu_municipio`, `giu_telefono`, `giu_celular`, `giu_email`, `giu_direccion`, `giu_informacion_poblacional`, `giu_atencion_preferencial`, `giu_genero`, `giu_escolaridad`, `giu_fecha_actualiza`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `giu_tipo_documento`=?, `giu_primer_nombre`=?, `giu_segundo_nombre`=?, `giu_primer_apellido`=?, `giu_segundo_apellido`=?, `giu_fecha_nacimiento`=?, `giu_municipio`=?, `giu_telefono`=?, `giu_celular`=?, `giu_email`=?, `giu_direccion`=?, `giu_informacion_poblacional`=?, `giu_atencion_preferencial`=?, `giu_genero`=?, `giu_escolaridad`=?, `giu_fecha_actualiza`=?");
                  // Agrega variables a sentencia preparada
                  $sentencia_insert_usuario->bind_param('sssssssssssssssssssssssssssssssss', $identificacion, $tipo_documento, $primer_nombre, $segundo_nombre, $primer_apellido, $segundo_apellido, $fecha_nacimiento, $municipio, $telefono, $celular, $email, $direccion, $informacion_poblacional_insert, $atencion_preferencial_insert, $genero, $escolaridad, date('Y-m-d H:i:s'), $tipo_documento, $primer_nombre, $segundo_nombre, $primer_apellido, $segundo_apellido, $fecha_nacimiento, $municipio, $telefono, $celular, $email, $direccion, $informacion_poblacional_insert, $atencion_preferencial_insert, $genero, $escolaridad, date('Y-m-d H:i:s'));
                  $sentencia_insert_usuario->execute();
                }

                if($dup_id_caso=='' AND ($canal_atencion=='SMS' OR $canal_atencion=='WhatsApp') AND $id_encuesta_fecha!='' AND $id_encuesta!='') {
                    // Prepara la sentencia
              ...
              $respuesta_accion = "alertButton('error', 'Error', 'Problemas al crear el registro #1');";
            }
          } else {
            $respuesta_accion = "alertButton('error', 'Error', 'Problemas al crear el registro, por favor verifique e intente nuevamente #2');";
          }
      } else {
          $respuesta_accion = "alertButton('success', 'Registro creado', 'Registro creado exitosamente');";
      }
...
<body class="sidebar-dark sidebar-icon-only">
                    ...
                    <div class="card-body">
                      ...
                      <div class="col-md-12">
                          <div class="form-group my-1">
                            ...
                            <input type="text" class="form-control form-control-sm" name="id_caso" id="id_caso" maxlength="150" value="<?php if(isset($_POST["guardar_registro"])){ echo $id_caso; } elseif($dup_id_caso!=''){ echo $dup_id_caso; } ?>" <?php if($_SESSION[APP_SESSION.'_registro_creado_interaccion'.$token]==1) { echo 'readonly'; } ?> onkeyup="validar_url_encuesta();" onchange="validar_url_encuesta();" required>
  ...
  <script type="text/javascript">
      function validar_canal_atencion(){
          ...
          if(canal_atencion=="Chat web" || canal_atencion=="Video llamada" || canal_atencion=="SMS" || canal_atencion=="Redes Sociales" || canal_atencion=="Web Call Back" || canal_atencion=="Lengua de Señas" || canal_atencion=="Kiosko" || canal_atencion=="Clic to Call" || canal_atencion=="WhatsApp") {
          ...
          // Cabinas |Chat web|Clic to Call|Inbound|Kiosko|Lengua de Señas|Lenguas Nativas|Outbound|Redes Sociales|SMS|Video llamada|Web Call Back|WhatsApp
      ...
      function validar_sms(){
            ...
            if(direcciones_misionales=="JÓVENES EN ACCIÓN" && (programa=="ENTREGA DE INCENTIVOS" && (tipificacion=="1. INFORMACIÓN DE FECHAS DE TMC Y/O MESES LIQUIDADOS, IES QUE REPORTAN, CADA CUÁNTO SE GENERA TMC, DOCUMENTO PARA RECIBIR TMC/ CRONOGRAMA DE ENTREGA" || tipificacion=="2. RELIQUIDACIÓN/RETROACTIVO/NO COBROS GENERADOS EN EL SISTEMA") || programa=="NO TMC" && (tipificacion=="1. ESTADO DIFERENTE A ACTIVO EN LA PESTAÑA DE FORMACIÓN" || tipificacion=="2.EL PERÍODO DE VERIFICACIÓN ES MENOR O MAYOR A LA FECHA DE VINCULACIÓN/FINALIZO INTERVENCIÒN PESTAÑA FORMACIÓN" || tipificacion=="3.NO CUMPLE PROMEDIO PERMANENCIA/EXCELENCIA" || tipificacion=="4. JOVEN EN PERÍODO DE GRACIA/ NO SE ENCUENTRA EN ETAPA PRODUCTIVA NI LECTIVA/ INCONSISTENCIA EN FECHAS O REPORTE DE ETAPAS (LECTIVA O PRODUCTIVA)" || tipificacion=="5.NO REPORTE (IES/SENA)" || tipificacion=="6.REGISTRO AL PROGRAMA JEA ES MUY RECIENTE." || tipificacion=="7.DIFERENCIA EN EL NÚMERO DE PERÍODOS ACADÉMICOS REPORTADOS/PERIODO ACADÉMICO NO HA AUMENTADO" || tipificacion=="8.DIFERENCIAS EN PROGRAMA DE FORMACIÓN. SNIES REPORTADO POR LA IES NO ES IGUAL AL ALMACENADO EN SIJA" || tipificacion=="9. ESTADO EN TRÁNSITO NIVEL DE FORMACIÓN/CAMBIO DE PROGRAMA DE FORMACIÓN/APLAZADO"))) {
            ...
            } else if(direcciones_misionales=="RENTA CIUDADANA" && programa=="INFORMACIÓN BANCO Y PAGOS") {
                var sms = document.getElementById('sms').disabled=false;

            } else if(direcciones_misionales=="RENTA JOVEN" && programa=="INFORMACIÓN BANCO Y/O PAGOS") {
                var sms = document.getElementById('sms').disabled=false;


            } else if(
                (direcciones_misionales=="RENTA JOVEN"
                    || direcciones_misionales=="COLOMBIA MAYOR"
                    || direcciones_misionales=="RENTA CIUDADANA"
                    || direcciones_misionales=="COMPENSACIÓN DEL IVA"
                    || direcciones_misionales=="COMPENSACIÓN DE IVA"
                )
                && programa=="INFORMACIÓN GENERAL Y PAGOS"
                && (tipificacion.includes("INFORMACIÓN DE PAGOS") || tipificacion.includes("INFORMACION DE PAGOS"))
                && tipificacion.includes("CONTACTOS ENTIDAD FINANCIERA")
                && tipificacion.includes("ALIADOS")
            ) {
                var sms = document.getElementById('sms').disabled=false;
                ...
                && programa=="INFORMACIÓN GENERAL Y TRANSFERENCIAS"
                && (tipificacion.includes("INFORMACIÓN DE TRANSFERENCIAS") || tipificacion.includes("INFORMACION DE TRANSFERENCIAS"))
                && tipificacion.includes("CONTACTOS ENTIDAD FINANCIERA")
                && tipificacion.includes("ALIADOS")
            ) {
                var sms = document.getElementById('sms').disabled=false;
      ...
      function validar_url_encuesta(){
          ...
          if(id_caso!="" && (canal_atencion=="SMS" || canal_atencion=="WhatsApp") && id_encuesta_fecha!="") {
              document.getElementById("id_encuesta").value=id_encuesta_fecha+"-"+id_caso;
              $("#url_encuesta").html("https://portalkiosko.asdcloud.co/templates/encuesta/satisfaccion?int="+btoa(id_encuesta_fecha+"-"+id_caso));
