...
// ini_set('display_errors', '1');
  ...
  if(isset($_POST["guardar_registro"])){
      ...
      if($_SESSION[APP_SESSION.'_registro_creado_interaccion'.$token]!=1){
          ...
          if ($sentencia_insert->execute() AND $sentencia_insert_detalle->execute()) {
  ...
  $consulta_string_direcmisionales="SELECT `gic1_id`, `gic1_item`, `gic1_estado`, `gic1_registro_usuario`, `gic1_registro_fecha` FROM `gestion_interacciones_catnivel1` WHERE `gic1_estado`='Activo' ORDER BY `gic1_item` ASC";
...
<body class="sidebar-dark sidebar-icon-only">
                    ...
                    <div class="card-body">
                      ...
                      <div class="col-md-12">
                          <div class="form-group my-1">
                              ...
                              <select class="selectpicker form-control form-control-sm form-select" data-live-search="false" data-container="body" name="informacion_poblacional[]" id="informacion_poblacional" title="Seleccione" multiple <?php if($_SESSION[APP_SESSION.'_registro_creado_interaccion'.$token]==1) { echo 'disabled'; } ?> required>
                      ...
                      <div class="col-md-12">
                          <div class="form-group my-1">
                              ...
                              <select class="selectpicker form-control form-control-sm form-select" data-live-search="false" data-container="body" name="atencion_preferencial[]" id="atencion_preferencial" title="Seleccione" multiple <?php if($_SESSION[APP_SESSION.'_registro_creado_interaccion'.$token]==1) { echo 'disabled'; } ?> required>
                    ...
                    <div class="card-body row">
                      ...
                      <div class="col-md-4">
                          <div class="form-group my-1">
                              ...
                              <select class="selectpicker form-control form-control-sm form-select" data-live-search="true" data-container="body" name="tipificacion" id="tipificacion" title="Seleccione" <?php if($_SESSION[APP_SESSION.'_registro_creado_interaccion'.$token]==1) { echo 'disabled'; } ?> required onchange="validar_nivel3();">
  ...
  <script type="text/javascript">
      function validar_canal_atencion(){
          ...
          if(canal_atencion=="Redes Sociales") {
              ...
              document.getElementById('municipio').html("");
              ...
              $("#respuesta_datos_usuario").html('<p class="alert alert-warning p-1 font-size-11">¡Canal de atención no require datos personales del usuario!</p>');
          } else {
      ...
      function validar_sms(){
          ...
          if(direcciones_misionales=="SUBDIRECCIÓN DE PROGRAMAS Y PROYECTOS" && programa=="DIRECCIÓN DE TRANSFERENCIAS MONETARIAS" && tipificacion=="SUBDIRECCIÓN DE TRANSFERENCIAS MONETARIAS CONDICIONADAS" && subtipificacion_1=="FAMILIAS EN ACCIÓN" && subtipificacion_2=="ENTREGA DE INCENTIVOS" && (subtipificacion_3=="1.INFORMACIÓN TMC/MESES GENERADOS EDUCACIÓN Y/O SALUD/BENEFICIARIOS CON TMC/CRONOGRAMA DE ENTREGA" || subtipificacion_3=="2. RELIQUIDACION/RETROACTIVO/NO COBROS GENERADOS EN EL SISTEMA")) {
              var sms = document.getElementById('sms').disabled=false;
          } else if(direcciones_misionales=="SUBDIRECCIÓN DE PROGRAMAS Y PROYECTOS" && programa=="DIRECCIÓN DE TRANSFERENCIAS MONETARIAS" && tipificacion=="SUBDIRECCIÓN DE TRANSFERENCIAS MONETARIAS CONDICIONADAS" && subtipificacion_1=="JÓVENES EN ACCIÓN" && subtipificacion_2=="ENTREGA DE INCENTIVOS" && (subtipificacion_3=="1. INFORMACIÓN DE FECHAS DE TMC Y/O MESES LIQUIDADOS, IES QUE REPORTAN, CADA CUANTO SE GENERA TMC, DOCUMENTO PARA RECIBIR TMC/ CRONOGRAMA DE ENTREGA" || subtipificacion_3=="2. RELIQUIDACION/RETROACTIVO/NO COBROS GENERADOS EN EL SISTEMA")) {
              var sms = document.getElementById('sms').disabled=false;
          } else if(direcciones_misionales=="SUBDIRECCIÓN DE PROGRAMAS Y PROYECTOS" && programa=="DIRECCIÓN DE TRANSFERENCIAS MONETARIAS" && tipificacion=="SUBDIRECCIÓN DE TRANSFERENCIAS MONETARIAS NO CONDICIONADAS" && (subtipificacion_1=="COLOMBIA MAYOR" || subtipificacion_1=="IVA")) {
              var sms = document.getElementById('sms').disabled=false;
          } else if(direcciones_misionales=="SUBDIRECCIÓN DE PROGRAMAS Y PROYECTOS" && programa=="DIRECCIÓN DE TRANSFERENCIAS MONETARIAS" && tipificacion=="SUBDIRECCIÓN DE TRANSFERENCIAS MONETARIAS NO CONDICIONADAS" && subtipificacion_1=="INGRESO SOLIDARIO" && subtipificacion_2=="INFORMACIÓN DE PAGOS") {
              var sms = document.getElementById('sms').disabled=false;
          } else {
              var sms = document.getElementById('sms').disabled=true;
          }
