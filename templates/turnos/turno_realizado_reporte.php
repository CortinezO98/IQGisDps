...
<div class="modal fade" id="modal-reporte" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form name="reporte" action="turno_realizado_reporte_excel.php" method="POST">
          ...
          <div class="col-md-12">
              <div class="form-group">
                  ...
                  <select class="form-control form-control-sm form-select" name="tipo_reporte" id="tipo_reporte" required>
                      ...
                      <option value="Log actividades">Log actividades</option>
                  </select>
              </div>
          </div>
          <div class="col-md-12">
              <div class="form-group">
                  ...
                  <select class="form-control form-control-sm form-select" name="campania" id="campania" required>
